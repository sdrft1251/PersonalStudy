...
x_train = x_train.reshape(-1,144,37,1)
x_test = x_test.reshape(-1,144,37,1)
print(x_train.shape, y_train.shape, x_test.shape, y_test.shape)


def return_model():
    input_tens = tf.keras.Input(shape=(144,37,1))
    x = tf.keras.layers.Permute((2,1,3))(input_tens)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(16, kernel_size=10, padding="valid"))(x)
    ...
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(32, kernel_size=5, padding="valid"))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.LayerNormalization())(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.ReLU())(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(32, kernel_size=5, padding="valid"))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.LayerNormalization())(x)
    ...
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.LayerNormalization())(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.ReLU())(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(16, kernel_size=5, padding="valid"))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.LayerNormalization())(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.ReLU())(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.Conv1D(8, kernel_size=5, padding="valid"))(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.LayerNormalization())(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.ReLU())(x)
    x = tf.keras.layers.TimeDistributed(tf.keras.layers.GlobalAveragePooling1D())(x)
    x = tf.keras.layers.Conv1D(3, kernel_size=37, padding="valid")(x)
